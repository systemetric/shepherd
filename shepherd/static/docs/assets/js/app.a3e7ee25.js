        ...
        (u.charset = "utf-8"),
          ...
          (u.src = (function(t) {
            return (
              ...
              ({}[t] || t) +
              "." +
              { 1: "70ab60fe", 2: "2596547c", 3: "57d711ef", 4: "7856f4dd" }[
                t
              ] +
              ".js"
            );
  ...
  function(t, e, n) {
    for (
      ...
      var d,
        ...
        g = m && m.prototype;
      if (g)
        for (d in (g[u] || a(g, u, l), g[f] || a(g, f, v), (s[v] = l), r))
          g[d] || o(g, d, r[d], !0);
    }
  },
  function(t, e) {
 ...
 * @license MIT */ void 0 ===
    ...
    t.exports = function(t, e, n, u, f) {
      ...
      if (i(d))
        for (l = s(t.length); l > m; m++)
          e ? v(a((p = t[m]))[0], p[1]) : v(t[m]);
      else for (h = d.call(t); !(p = h.next()).done; ) o(h, v, p.value, e);
    };
  },
  function(t, e, n) {
    var r = n(54),
  ...
  function(t, e, n) {
    ...
    var kt = function(t) {
      ...
      B(t, "__ob__", this),
      Array.isArray(t))
        ? ((W ? Ct : $t)(t, _t, bt), this.observeArray(t))
        : this.walk(t);
    };
    function Ct(t, e, n) {
      t.__proto__ = e;
        ...
        e.computed &&
          (function(t, e) {
            ...
            for (var o in e) {
              ...
              0, r || (n[o] = new Le(t, a || j, j, Me)), o in t || Ne(t, o, i);
            }
          })(t, e.computed),
        e.watch &&
          e.watch !== Z &&
    ...
    Ar &&
      ...
      void 0 === window.onanimationend &&
        ...
        ((Ir = "WebkitAnimation"), (Rr = "webkitAnimationEnd")));
    var Mr = z
        ...
        if (!O || x || "" === x) {
          ...
          var N = !1 !== a && !Y,
            ...
            U = (n._enterCb = R(function() {
              N && (Ur(n, j), Ur(n, A)),
                U.cancelled ? (N && Ur(n, E), I && I(n)) : P && P(n),
                (n._enterCb = null);
            }));
          t.data.show ||
            ...
            N &&
              ...
              Nr(function() {
                Ur(n, E),
                  U.cancelled ||
                    (Dr(n, j), D || (Gr(M) ? setTimeout(U, M) : Fr(n, s, U)));
              })),
    ...
    function Ao(t, e, n, r) {
      ...
      return n && (a.redirectedFrom = Lo(n, o)), Object.freeze(a);
    }
    function jo(t) {
    ...
    var Ro,
      ...
      Do = {
        ...
        render: function(t) {
          ...
          var m = function(t) {
              Uo(t) && (e.replace ? n.replace(i) : n.push(i));
            },
            g = { click: Uo };
    ...
    var Fo = "undefined" != typeof window;
    function Bo(t, e, n) {
      var r = t.charAt(0);
      if ("/" === r) return t;
      if ("?" === r || "#" === r) return e + t;
    ...
    function Zo(t) {
      ...
      return function(n, r) {
        for (
          var o = "",
            i = n || {},
            a = (r || {}).pretty ? Jo : encodeURIComponent,
            s = 0;
          s < t.length;
          s++
        ) {
          ...
          if ("string" != typeof c) {
            ...
            if (Ho(f)) {
              ...
              if (((u = c.asterisk ? Qo(f) : a(f)), !e[s].test(u)))
                throw new TypeError(
                  'Expected "' +
                    c.name +
                    '" to match "' +
    ...
    function oi(t, e, n) {
      ...
      var f = ti(n.delimiter || "/"),
        l = i.slice(-f.length) === f;
      return (
        r || (i = (l ? i.slice(0, -f.length) : i) + "(?:" + f + "(?=$))?"),
        (i += o ? "$" : r && l ? "" : "(?=" + f + "|$)"),
        ni(new RegExp("^" + i, ri(n)), e)
      );
    }
    function ii(t, e, n) {
      return (
          ...
          : Ho(t)
            ? (function(t, e, n) {
                for (var r = [], o = 0; o < t.length; o++)
                  r.push(ii(t[o], e, n).source);
                return ni(new RegExp("(?:" + r.join("|") + ")", ri(n)), e);
              })(t, e, n)
            : (function(t, e, n) {
                return oi(Yo(t, n), e, n);
              })(t, e, n)
      );
    }
    (Wo.parse = zo),
      (Wo.compile = Vo),
      (Wo.tokensToFunction = Go),
      (Wo.tokensToRegExp = Ko);
    var ai = Object.create(null);
    function si(t, e, n) {
      try {
        return (ai[t] || (ai[t] = Wo.compile(t)))(e || {}, { pretty: !0 });
      } catch (t) {
        return "";
      }
    }
    ...
    function ui(t, e, n, r) {
      ...
      if (!o.path && o.params && e) {
        (o = fi({}, o))._normalized = !0;
        var i = fi(fi({}, e.params), o.params);
        if (e.name) (o.name = e.name), (o.params = i);
        else if (e.matched.length) {
          var a = e.matched[e.matched.length - 1].path;
          o.path = si(a, i, e.path);
        } else 0;
        return o;
      }
      var s = (function(t) {
        ...
        c = (e && e.path) || "/",
        u = s.path ? Bo(s.path, c, n || o.append) : c,
        f = (function(t, e, n) {
          void 0 === e && (e = {});
          var r,
            o = n || So;
    ...
    function li(t, e) {
      ...
      function a(t, n, a) {
        ...
        if (u) {
          ...
          if (f) return (s.path = si(f.path, s.params)), c(f, s, a);
        } else if (s.path) {
          s.params = {};
      ...
      function s(t, n) {
        var r = t.redirect,
          o = "function" == typeof r ? r(Ao(t, n, null, e)) : r;
        if (
        ...
        if (f) {
          var d = (function(t, e) {
            return Bo(t, e.parent ? e.parent.path : "/", !0);
          })(f, t);
          return a(
            { _normalized: !0, path: si(d, h), query: l, hash: p },
            void 0,
            n
          );
        }
      ...
      function c(t, n, r) {
        return t && t.redirect
          ...
          : t && t.matchAs
            ? (function(t, e, n) {
                var r = a({ _normalized: !0, path: si(n, e.params) });
                if (r) {
                  var o = r.matched,
                    i = o[o.length - 1];
    ...
    function di() {
      window.history.replaceState({ key: $i() }, ""),
    ...
    function mi() {
      var t = $i();
      t && (hi[t] = { x: window.pageXOffset, y: window.pageYOffset });
    }
    function gi(t) {
    ...
    function yi(t) {
      return {
        x: _i(t.x) ? t.x : window.pageXOffset,
        y: _i(t.y) ? t.y : window.pageYOffset
      };
    }
    function _i(t) {
      ...
      if (n && "string" == typeof t.selector) {
        ...
        if (r) {
          ...
          e = (function(t, e) {
            ...
            r,
            (o = (function(t) {
              return { x: _i(t.x) ? t.x : 0, y: _i(t.y) ? t.y : 0 };
            })(o))
          );
        } else gi(t) && (e = yi(t));
      } else n && gi(t) && (e = yi(t));
    ...
    var xi =
      ...
      wi =
        Fo && window.performance && window.performance.now
          ? window.performance
          : Date,
      ki = Ci();
    function Ci() {
      return wi.now().toFixed(3);
    }
    function $i() {
      return ki;
    }
          ...
          if ("function" == typeof t && void 0 === t.cid) {
            ...
            var c,
              u = Pi(function(e) {
                (function(t) {
                  return (
                    t.__esModule || (Li && "Module" === t[Symbol.toStringTag])
                  );
                })(e) && (e = e.default),
    ...
    (Ii.prototype.listen = function(t) {
      this.cb = t;
    }),
      (Ii.prototype.onReady = function(t, e) {
        this.ready
          ? t()
          : (this.readyCbs.push(t), e && this.readyErrorCbs.push(e));
      }),
      (Ii.prototype.onError = function(t) {
        this.errorCbs.push(t);
      }),
      (Ii.prototype.transitionTo = function(t, e, n) {
        var r = this,
      ...
      (Ii.prototype.confirmTransition = function(t, e, n) {
        var r = this,
          o = this.current,
          i = function(t) {
            _o(t) &&
        ...
        if (Po(t, o) && t.matched.length === o.matched.length)
        ...
        var a = (function(t, e) {
          ...
          f = [].concat(
            (function(t) {
              return Ri(t, "beforeRouteLeave", Mi, !0);
            })(c),
            this.router.beforeHooks,
            (function(t) {
              return Ri(t, "beforeRouteUpdate", Mi);
            })(s),
            u.map(function(t) {
        ...
        Ei(f, l, function() {
          ...
          Ei(
            (function(t, e, n) {
              return Ri(t, "beforeRouteEnter", function(t, r, o, i) {
                return (function(t, e, n, r, o) {
      ...
      (Ii.prototype.updateRoute = function(t) {
        var e = this.current;
        (this.current = t),
          this.cb && this.cb(t),
      ...
      return (
        ...
        (e.prototype.push = function(t, e, n) {
          ...
          this.transitionTo(
            t,
            function(t) {
              Si(qo(r.base + t.fullPath)), vi(r.router, t, o, !1), e && e(t);
            },
            n
          );
        }),
        (e.prototype.replace = function(t, e, n) {
          ...
          this.transitionTo(
            t,
            function(t) {
              Oi(qo(r.base + t.fullPath)), vi(r.router, t, o, !1), e && e(t);
            },
            n
          );
        }),
        (e.prototype.ensureURL = function(t) {
          if (Di(this.base) !== this.current.fullPath) {
        ...
        t.call(this, e, n),
          (r &&
            (function(t) {
              var e = Di(t);
              if (!/^\/#/.test(e))
                return window.location.replace(qo(t + "/#" + e)), !0;
            })(this.base)) ||
            Fi();
      }
      return (
        ...
        (e.prototype.setupListeners = function() {
          ...
          n && di(),
            window.addEventListener(xi ? "popstate" : "hashchange", function() {
              var e = t.current;
              Fi() &&
                t.transitionTo(Bi(), function(r) {
                  n && vi(t.router, r, e, !0), xi || Wi(r.fullPath);
                });
            });
        }),
        (e.prototype.push = function(t, e, n) {
          ...
          this.transitionTo(
            t,
            function(t) {
              Hi(t.fullPath), vi(r.router, t, o, !1), e && e(t);
            },
            n
          );
        }),
        (e.prototype.replace = function(t, e, n) {
          ...
          this.transitionTo(
            t,
            function(t) {
              Wi(t.fullPath), vi(r.router, t, o, !1), e && e(t);
            },
            n
          );
        }),
    ...
    function Hi(t) {
      xi ? Si(qi(t)) : (window.location.hash = t);
    }
    function Wi(t) {
      xi ? Oi(qi(t)) : window.location.replace(qi(t));
    }
    var zi = (function(t) {
        function e(e, n) {
      ...
      Vi = function(t) {
        ...
        var e = t.mode || "hash";
        switch (
          ((this.fallback = "history" === e && !xi && !1 !== t.fallback),
          ...
          case "history":
            this.history = new Ni(this, t.base);
            break;
          case "hash":
            this.history = new Ui(this, t.base, this.fallback);
            break;
          case "abstract":
            this.history = new zi(this, t.base);
            break;
          default:
            0;
        }
      },
      Gi = { currentRoute: { configurable: !0 } };
    function Ki(t, e) {
      return (
        t.push(e),
        function() {
    ...
    (Vi.prototype.match = function(t, e, n) {
      return this.matcher.match(t, e, n);
    }),
      (Gi.currentRoute.get = function() {
        return this.history && this.history.current;
      }),
      (Vi.prototype.init = function(t) {
        var e = this;
        if ((this.apps.push(t), !this.app)) {
          this.app = t;
          var n = this.history;
          if (n instanceof Ni) n.transitionTo(n.getCurrentLocation());
      ...
      (Vi.prototype.beforeEach = function(t) {
        return Ki(this.beforeHooks, t);
      }),
      (Vi.prototype.beforeResolve = function(t) {
        return Ki(this.resolveHooks, t);
      }),
      (Vi.prototype.afterEach = function(t) {
        return Ki(this.afterHooks, t);
      }),
      (Vi.prototype.onReady = function(t, e) {
        this.history.onReady(t, e);
      }),
      (Vi.prototype.onError = function(t) {
        this.history.onError(t);
      }),
      (Vi.prototype.push = function(t, e, n) {
        this.history.push(t, e, n);
      }),
      (Vi.prototype.replace = function(t, e, n) {
        this.history.replace(t, e, n);
      }),
      (Vi.prototype.go = function(t) {
        this.history.go(t);
      }),
      (Vi.prototype.back = function() {
        this.go(-1);
      }),
      (Vi.prototype.forward = function() {
        this.go(1);
      }),
      (Vi.prototype.getMatchedComponents = function(t) {
      ...
      (Vi.prototype.resolve = function(t, e, n) {
        var r = ui(t, e || this.history.current, n, this),
          o = this.match(r, e),
      ...
      (Vi.prototype.addRoutes = function(t) {
        this.matcher.addRoutes(t),
          this.history.current !== To &&
            this.history.transitionTo(this.history.getCurrentLocation());
      }),
      Object.defineProperties(Vi.prototype, Gi),
      (Vi.install = function t(e) {
        if (!t.installed || Ro !== e) {
          (t.installed = !0), (Ro = e);
          var n = function(t) {
              return void 0 !== t;
          ...
          e.mixin({
            ...
            e.component("router-view", bo),
            e.component("router-link", Do);
      ...
      (Vi.version = "3.0.1"),
      Fo && window.Vue && window.Vue.use(Vi);
    var Xi = Vi;
    n(98), n(18), n(27), n(15), n(28), n(63), n(30), n(64);
    function Yi(t) {
      return (
        (function(t) {
          if (Array.isArray(t)) {
    ...
    function Ji(t, e) {
      var n;
      t.mixins || (t.mixins = []), (n = t.mixins).push.apply(n, Yi(e));
    }
    var Qi = { disableScrollBehavior: !1 },
      Zi = n(48),
      ta = n.n(Zi),
      ea = (n(20), n(105), n(107), n(31), n(108), n(83), n(32), /#.*$/),
      na = /\.(md|html)$/,
      ra = /\/$/,
      oa = /^(https?:|mailto:|tel:)/;
    function ia(t) {
    ...
    function ua(t, e, n) {
      ...
      for (var r = ia(e), o = 0; o < t.length; o++)
        if (ia(t[o].path) === r)
          return Object.assign({}, t[o], { type: "page", path: sa(e) });
      return (
        console.error(
    ...
    function fa(t, e, n, r) {
      ...
      if (s) {
        var c = (function(t, e) {
            ...
            for (var n in e)
              if (0 === ha(t.path).indexOf(n)) return { base: n, config: e[n] };
            return {};
          })(e, s),
          u = c.base,
          f = c.config;
        return f
          ? f.map(function(t) {
              return (function t(e, n, r, o) {
                if ("string" == typeof e) return ua(n, e, r);
                if (Array.isArray(e))
                  return Object.assign(ua(n, e[0], r), { title: e[1] });
                o &&
                  console.error(
    ...
    ma.options.__file = "NavLink.vue";
    var ga = ma.exports,
      ya = {
        components: { NavLink: ga },
        computed: {
          data: function() {
    ...
    xa.options.__file = "SidebarButton.vue";
    var wa = xa.exports,
      ka = (n(111),
      {
        data: function() {
    ...
    Ca.options.__file = "SearchBox.vue";
    var $a = Ca.exports,
      Sa = (n(115),
      {
    ...
    Oa.options.__file = "DropdownTransition.vue";
    var Ea = Oa.exports,
      Aa = {
        components: { NavLink: ga, DropdownTransition: Ea },
        data: function() {
          return { open: !1 };
        },
        props: { item: { required: !0 } },
    ...
    ja.options.__file = "DropdownLink.vue";
    var Ta = {
        components: { NavLink: ga, DropdownLink: ja.exports },
        computed: {
          userNav: function() {
            return (
          ...
          nav: function() {
            ...
            if (e && Object.keys(e).length > 1) {
              ...
              return Yi(this.userNav).concat([i]);
            }
            return this.userNav;
          },
          userLinks: function() {
            return (this.nav || []).map(function(t) {
              return Object.assign(pa(t), { items: (t.items || []).map(pa) });
            });
          },
          repoLink: function() {
    ...
    La.options.__file = "NavLinks.vue";
    var Pa = La.exports;
    function Ia(t, e) {
    ...
    var Ra = {
        ...
        mounted: function() {
          var t = this,
            e =
              parseInt(Ia(this.$el, "paddingLeft")) +
              parseInt(Ia(this.$el, "paddingRight")),
            n = function() {
    ...
    Ma.options.__file = "Navbar.vue";
    var Na = Ma.exports;
    function Da(t, e, n) {
      var r = [];
      e.forEach(function(t) {
        "group" === t.type ? r.push.apply(r, Yi(t.children || [])) : r.push(t);
      });
        ...
        computed: {
          ...
          prev: function() {
            ...
            return !1 === t
              ? void 0
              : t
                ? ua(this.$site.pages, t, this.$route.path)
                : (function(t, e) {
                    return Da(t, e, -1);
        ...
        methods: {
          createEditLink: function(t, e, n, r, o) {
            return /bitbucket.org/.test(t)
              ...
              : (oa.test(e) ? e : "https://github.com/".concat(e)).replace(
                  ra,
                  ""
                ) +
                  "/edit/".concat(r) +
        ...
        : t(
            ...
            e.map(function(e) {
              ...
              return t("li", { class: "sidebar-sub-header" }, [
                qa(t, n + "#" + e.slug, e.title, a),
                Ha(t, e.children, n, r, o, i + 1)
              ]);
            })
          );
    }
    var Wa = {
        ...
        render: function(t, e) {
              ...
              "auto" === a.type
                ? s ||
                  a.children.some(function(t) {
                    return ca(i, a.basePath + "#" + t.slug);
                  })
                : s,
            u = qa(t, a.path, a.title || a.path, c),
            f =
          ...
          return "auto" === a.type
            ? [u, Ha(t, a.children, a.basePath, i, l)]
            : (c || p) && a.headers && !ea.test(a.path)
              ? [u, Ha(t, la(a.headers), a.path, i, l)]
              : u;
        }
      },
      za = (n(123), Object(va.a)(Wa, void 0, void 0, !1, null, null, null));
    za.options.__file = "SidebarLink.vue";
    var Va = za.exports,
      Ga = {
        name: "SidebarGroup",
        props: ["item", "first", "open", "collapsable"],
        components: { SidebarLink: Va, DropdownTransition: Ea }
      },
      Ka = (n(124),
      Object(va.a)(
        Ga,
    ...
    Ka.options.__file = "SidebarGroup.vue";
    var Xa = {
        components: { SidebarGroup: Ka.exports, SidebarLink: Va, NavLinks: Pa },
        props: ["items"],
        data: function() {
        ...
        computed: {
          popupConfig: function() {
            for (
              ...
              if (n && n.updatePopup)
                return "object" === Za(n.updatePopup) ? n.updatePopup : {};
            }
            return null;
          },
          enabled: function() {
    ...
    es.options.__file = "SWUpdatePopup.vue";
    var ns = {
        components: {
          Home: ba,
          Page: Ba,
        ...
        computed: {
          ...
          sidebarItems: function() {
            return fa(this.$page, this.$route, this.$site, this.$localePath);
          },
        ...
        mounted: function() {
          ...
          window.addEventListener("scroll", this.onScroll),
            ta.a.configure({ showSpinner: !1 }),
            this.$router.beforeEach(function(t, e, n) {
              t.path === e.path || yo.component(t.name) || ta.a.start(), n();
            }),
            this.$router.afterEach(function() {
              ta.a.done(), (t.isSidebarOpen = !1);
            }),
    ...
    ss.options.__file = "NotFound.vue";
    var cs = ss.exports,
      us = (n(129),
      n(131),
      {
        ...
        mounted: function() {
          ...
          var e = function() {
            ...
            r.length &&
              ...
              (t.currentMetaTags = new Set(fs(n, t.currentMetaTags)));
          };
          this.$watch("$page", e), e();
        },
        beforeDestroy: function() {
          fs(null, this.currentMetaTags);
        }
      });
    function fs(t, e) {
      if (
            ...
            setActiveHash: function() {
              for (
                ...
                if (
                  ...
                  return (
                    (Qi.disableScrollBehavior = !0),
                    void this.$router.replace(
                      decodeURIComponent(i.hash),
                      function() {
                        t.$nextTick(function() {
                          Qi.disableScrollBehavior = !1;
                        });
                      }
                    )
                  );
    ...
    var hs = [
        {
          ...
          beforeEnter: function(t, e, r) {
            n.e(3)
              ...
              .then(function(t) {
                yo.component("v-4dc6c842857fa", t.default), r();
              });
          }
        },
        { path: "/index.html", redirect: "/" },
        {
          name: "v-40842074c764a",
          path: "/block-editor.html",
          component: os,
          beforeEnter: function(t, e, r) {
            n.e(4)
              .then(n.bind(null, 143))
              .then(function(t) {
                yo.component("v-40842074c764a", t.default), r();
              });
          }
        },
        { path: "*", component: cs }
            ...
            headers: [
              {
                ...
                slug: "connecting-to-the-robot"
              },
              { level: 2, title: "Blocks", slug: "blocks" },
              { level: 2, title: "Squares", slug: "squares" }
            ],
            frontmatter: {
              title: "Scratch-like Interface",
    ...
    ys.options.__file = "OutboundLink.vue";
    var _s = ys.exports;
    n.e(2).then(n.t.bind(null, 140, 7)),
      ...
      yo.component("Content", gs),
      yo.component("OutboundLink", _s),
      yo.component("Badge", function() {
        return n.e(1).then(n.bind(null, 141));
      }),
    ...
    var bs = (function() {
        var t = new Xi({
          ...
          scrollBehavior: function(t, e, n) {
            return (
              n ||
              (t.hash
                ? !Qi.disableScrollBehavior && { selector: t.hash }
                : { x: 0, y: 0 })
            );
          }
        });
        ...
        var e = {};
        return (
          ms({ Vue: yo, options: e, router: t, siteData: ds }),
          vs({ Vue: yo, options: e, router: t, siteData: ds }),
          {
            app: new yo(
              Object.assign(e, {
                router: t,
      ...
      xs = bs.app,
      ws = bs.router;
    (window.__VUEPRESS_VERSION__ = { version: "0.14.4", hash: "2f79289" }),
      ws.onReady(function() {
        xs.$mount("#app");
      });
  }
